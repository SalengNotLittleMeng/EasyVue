...
describe("expression parser", () => {
  describe("generateBinding", () => {
    ...
    it("object literal", () => {
      ...
      expect(
        generateBinding('{ a: 3, b: { bb: "bb", bbb: { bbc: "BBC" } } }')
    ...
    it("array literal", () => {
      ...
      expect(
        generateBinding(
          '{ a: [3,16], b: [{ bb: ["aa","bb"], bbb: [{bbc:"BBC"}] }] }'
        )
      ).toEqual({
        a: [3, 16],
        b: [{ bb: ["aa", "bb"], bbb: [{ bbc: "BBC" }] }],
      });
    });
    ...
    it("object bindings", () => {
      ...
      expect(
        generateBinding(`{ color: '#FF' + 66 * 100, fontSize: item.size }`)
      ).toEqual({
    ...
    it("array bindings", () => {
      ...
      expect(
      ...
      ).toEqual([
        {
          ...
          y: {
            yy: [
              { yyy: [{ "@binding": "obj.yy.y" }, { "@binding": "obj.y.yy" }] },
            ],
