...
describe("Usage", () => {
  ...
  describe("recycle-list", () => {
        ...
        .then((code) => {
          ...
          setTimeout(() => {
            const target = readObject(
              "recycle-list/components/stateless.vdom.js"
            );
            expect(getRoot(instance)).toEqual(target);
            instance.$destroy();
            done();
    ...
    it("stateless component with props", (done) => {
      compileWithDeps("recycle-list/components/stateless-with-props.vue", [
        ...
        .then((code) => {
          ...
          setTimeout(() => {
            const target = readObject(
              "recycle-list/components/stateless-with-props.vdom.js"
            );
            expect(getRoot(instance)).toEqual(target);
            instance.$destroy();
            done();
    ...
    it("multi stateless components", (done) => {
      compileWithDeps(
        "recycle-list/components/stateless-multi-components.vue",
        [
          {
            name: "banner",
            path: "recycle-list/components/banner.vue",
        ...
        .then((code) => {
          ...
          setTimeout(() => {
            const target = readObject(
              "recycle-list/components/stateless-multi-components.vdom.js"
            );
            expect(getRoot(instance)).toEqual(target);
            instance.$destroy();
            done();
      ...
      compileWithDeps("recycle-list/components/stateful.vue", [
        ...
        .then((code) => {
          ...
          setTimeout(() => {
            ...
            const target = readObject(
              "recycle-list/components/stateful.vdom.js"
            );
            expect(getRoot(instance)).toEqual(target);
            tasks.length = 0;
    ...
    it("stateful component with v-model", (done) => {
      compileWithDeps("recycle-list/components/stateful-v-model.vue", [
        ...
        .then((code) => {
          ...
          setTimeout(() => {
            const target = readObject(
              "recycle-list/components/stateful-v-model.vdom.js"
            );
            expect(getRoot(instance)).toEqual(target);
            instance.$destroy();
            done();
