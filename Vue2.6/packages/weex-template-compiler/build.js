...
function checkIdentifier(ident, type, text, warn$$1, range) {
...
function postTransformComponent(el, options) {
...
function shouldCompile(el, options) {
  return (
    options.recyclable || (currentRecycleList && el !== currentRecycleList)
  );
}
